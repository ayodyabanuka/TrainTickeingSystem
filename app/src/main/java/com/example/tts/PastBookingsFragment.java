...
import com.example.tts.Adapters.PastReservationAdapter;
...
public class PastBookingsFragment extends Fragment {
    ...
    private PastReservationAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<List<Reservation>> call = ApiClient.getReservationService().ReservationPastGet(nicsqlite);
        ...
        call.enqueue(new Callback<List<Reservation>>() {
            ...
            public void onResponse(Call<List<Reservation>> call, Response<List<Reservation>> response) {
                if (response.isSuccessful()) {
                    ...
                    adapter = new PastReservationAdapter(getActivity(),itemList);
